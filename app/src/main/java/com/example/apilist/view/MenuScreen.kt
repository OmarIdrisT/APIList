    ...
    Card(
        ...
        Row(
            ...
            Text(
                ...
                color = Color.White,
                textAlign = TextAlign.Center, modifier = Modifier.fillMaxSize().weight(1f)
            )
            IconButton(onClick = { myViewModel.favoritos = !myViewModel.favoritos }, modifier = Modifier.wrapContentWidth()) {
